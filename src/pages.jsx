...
export function Home() {
  usePageMeta(
    `${SITE} | Number Theory & STEM Student`,
    "Poet, Slam Performer & NCC Cadet."
  );
  return (
    <>
      <Hero />
...
export function About() {
  usePageMeta(`About | ${SITE}`, "Number Theory & STEM Student • Poet, Slam Performer & NCC Cadet.");
  return (
    <section className="section">
